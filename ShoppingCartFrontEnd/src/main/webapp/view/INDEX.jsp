...
<!--fonts-->
<link href='resources/fonts.googleapis.com/css?family=Lato:100,300,400,700,900'
	rel='stylesheet' type='text/css'>
<link href='resources/fonts.googleapis.com/css?family=Montez' rel='stylesheet'
	type='text/css'>
<!--//fonts-->
<!-- start menu -->
<!--//slider-script-->
	...
	<div class="header">
		<div class="header-top">
			...
			<div class="header-bottom">
				<div class="container">
					<div class="logo">
						<h1>
							<a href="index.html">I-<span>wear</span></a>
						</h1>
					</div>
					<!---->
		...
		<div class="banner">
			<div class="banner-top">
				...
				<img alt="" src="<c:url value="/resources/images/banner.jpg"/>"></img>
				<p>
			...
			<div class="product-one">
				...
				<div class="col-md-3 product-left">
					<div class="p-one simpleCart_shelfItem">
						...
						<a href="single.html"> <img src="images/n6.jpg" alt="" />
							<div class="mask">
								<span>Quick View</span>
							</div>
						</a>
